...
describe('checked-in sovereign baseline', () => {
  it('contains the exact 197-entry Chinese MFA baseline and no verified country', async () => {
    ...
    expect(registry.countries.every((entry) => entry.status === 'draft')).toBe(true);
    expect(registry.countries.some((entry) => entry.status === 'verified')).toBe(false);
  });
